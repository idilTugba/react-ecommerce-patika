...
axios.interceptors.request.use(function(config){
    ...
    if(allowedOrigins.includes(origin)) {config.headers.authorization = token;}
...
export const fetchOrderResult = async() =>{
